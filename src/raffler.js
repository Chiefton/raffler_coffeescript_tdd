...
(function() {
  ...
  Raffler.Views.EntriesIndex = (function(_super) {
    ...
    EntriesIndex.prototype.drawReset = function() {
      var winners;
      winners = this.collection;
      return winners.each(function(entry) {
        entry.set({
          winner: false
        });
        return entry.save();
  ...
  Raffler.Collections.Entries = (function(_super) {
    ...
    Entries.prototype.localStorage = new Store("Raffler-CofeeScript2");
